                ...
                <div className="flex space-x-2 items-center">
                    <div>
                        <div className="flex -space-x-px">
                            <Button
                                className={`rounded-r-none focus:z-10 hover:bg-green-300 ${lang === "Bangla"
                            ...
                            <Button
                                className={`rounded-none focus:z-10 hover:bg-green-300 ${lang === "English"
                                        ? "bg-green-800 text-white"
                                        : "bg-white text-black"
                                    }`}
                            ...
                            <Button
                                className={`rounded-l-none focus:z-10 hover:bg-green-300 ${lang === "Hindi"
                                        ? "bg-green-800 text-white"
                                        : "bg-white text-black"
                                    }`}
